      ...
      <View style={{flex: 1}}>
        <View style={{height: 150}}>
          <Image
            ...
            source={require('../Images/personal.jpg')}
          />
        </View>
        ...
        <View style={{flex: 1, marginTop: 50, marginLeft: 50, marginRight: 5}}>
          <ScrollView>
            <Text style={styles.Personal}> First Name</Text>
            <ImageBackground
            ...
            <Text style={styles.Personal}> Last Name</Text>
            <ImageBackground
              source={require('../Images/actogon-shape200x45.png')}
              style={styles.image}>
              <TextInput
            ...
            <Text style={styles.Personal}> Home</Text>
            <ImageBackground
              source={require('../Images/actogon-shape200x45.png')}
              style={styles.image}>
              <TextInput
            ...
            <Text style={styles.Personal}> Address</Text>
            <ImageBackground
              source={require('../Images/actogon-shape200x45.png')}
              style={styles.image}>
              <TextInput
            ...
            <Text style={styles.Personal}> FaceBook</Text>
            <ImageBackground
              source={require('../Images/actogon-shape200x45.png')}
              style={styles.image}>
              <TextInput
